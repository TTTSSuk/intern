...
//   it('7. should alert when next clicked without file', async () => {
//     const alertSpy = jest.spyOn(window, 'alert').mockImplementation(() => {});
    
//     render(<ListFile />);
//     await screen.findByText('file_a.zip');
    
//     // เลือกไฟล์ก่อน (เพื่อให้ปุ่มถัดไปปรากฏ)
//     const radios = screen.getAllByRole('radio');
//     fireEvent.click(radios[0]); // เลือก file_d.zip
    
//     // รอให้ปุ่มถัดไปปรากฏ
//     const nextButton = await screen.findByRole('button', { name: 'ถัดไป' });
    
//     // ยกเลิกการเลือก (uncheck) โดยการ set state เป็น null
//     // เนื่องจาก radio button ไม่สามารถ uncheck ได้โดยตรง
//     // เราต้องทดสอบผ่านการเรียก handleNext โดยที่ selectedFileId = null
    
//     // วิธีแก้: ทดสอบโดยการ render ใหม่โดยไม่เลือกไฟล์
//     // แต่เนื่องจากปุ่มจะไม่แสดงถ้าไม่เลือก เราต้องปรับวิธีทดสอบ
    
//     // ให้ทดสอบแบบนี้แทน: เลือกไฟล์ แล้วเคลียร์ selection ด้วย code
//     // หรือทดสอบฟังก์ชัน handleNext โดยตรง
